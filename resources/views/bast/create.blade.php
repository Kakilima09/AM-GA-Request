...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Buat BAST Baru</h4>
            <ol class="breadcrumb">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('bast.store') }}" method="POST" id="bastForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipe" class="form-control @error('tipe') is-invalid @enderror" required>
                            <option value="fa" {{ old('tipe') == 'fa' ? 'selected' : '' }}>Fixed Asset</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_pemohon" class="form-control @error('nama_pemohon') is-invalid @enderror" value="{{ old('nama_pemohon', Auth::user()->name) }}" required>
                        ...
                        @foreach($penerimaanFields as $key => $label)
                            <div class="col-md-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="{{ $key }}" name="{{ $key }}" value="1" {{ old($key) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="diserahkan_oleh" class="form-control @error('diserahkan_oleh') is-invalid @enderror" value="{{ old('diserahkan_oleh') }}" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="diterima_oleh" class="form-control @error('diterima_oleh') is-invalid @enderror" value="{{ old('diterima_oleh') }}" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="mengetahui" class="form-control @error('mengetahui') is-invalid @enderror" value="{{ old('mengetahui') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="menyetujui" class="form-control @error('menyetujui') is-invalid @enderror" value="{{ old('menyetujui') }}">
