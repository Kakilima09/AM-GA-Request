                        ...
                        <div class="card">
                            <div class="card-body p-0 auth-header-box">
                                <div class="text-center p-3">
                                    ...
                                    <h4 class="mt-3 mb-1 font-weight-semibold text-white font-18">Lupa Password</h4>
                                    <p class="text-light mb-0">Masukkan email Anda untuk mereset password.</p>
                                </div>
                            </div>
                            <div class="card-body">
                                @if (session('status'))
                                    ...
                                    <div class="form-group mb-0 row">
                                        <div class="col-12 mt-2">
                                            <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">
                                                Kirim Link Reset Password <i class="fas fa-envelope ml-1"></i>
                                            </button>
                                        </div>
                                    </div>
